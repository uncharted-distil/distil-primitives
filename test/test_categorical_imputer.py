...
class CategoricalImputerPrimitiveTestCase(unittest.TestCase):
    ...
    def test_defaults(self) -> None:
        ...
        # create the imputer
        hyperparams_class = \
            CategoricalImputerPrimitive.metadata.query()['primitive_code']['class_type_arguments']['Hyperparams']
    ...
    def test_constant(self) -> None:
        ...
        hyperparams_class = \
            CategoricalImputerPrimitive.metadata.query()['primitive_code']['class_type_arguments']['Hyperparams']
        imputer = CategoricalImputerPrimitive(hyperparams=hyperparams_class.defaults().replace({
            "strategy": "constant",
            "fill_value": "empty",
            "use_columns": [1,2,3,4]
        }))
