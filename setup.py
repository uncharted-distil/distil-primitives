...
setup(
    ...
    entry_points={
        'd3m.primitives': [
            ...
            'data_transformation.imputer.DistilSimpleImputer = distil.primitives.simple_imputer:SimpleImputerPrimitive',
            ...
            'data_transformation.data_cleaning.DistilZeroColumnRemover = distil.primitives.zero_column_remover:ZeroColumnRemoverPrimitive',
