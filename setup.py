...
setup(
    ...
    entry_points={
        "d3m.primitives": [
            ...
            "classification.support_vector_machine.DistilRankedLinearSVC = distil.primitives.ranked_linear_svc:RankedLinearSVCPrimitive",
            ...
            "data_transformation.data_cleaning.DistilTimeSeriesFormatter = distil.primitives.time_series_formatter:TimeSeriesFormatterPrimitive",
            "data_preprocessing.vector_bounds_filter.DistilVectorBoundsFilter = distil.primitives.vector_filter:VectorBoundsFilterPrimitive",
            ...
            "data_transformation.binning.DistilTimeSeriesBinner = distil.primitives.time_series_binner:TimeSeriesBinnerPrimitive",
