...
__all__ = ('ExlineSingleGraphLoaderPrimitive',)
...
class ExlineSingleGraphLoaderPrimitive(transformer.TransformerPrimitiveBase[Inputs, Outputs, Hyperparams]):
    """
    ...
    metadata = metadata_base.PrimitiveMetadata(
        {
            ...
            'python_path': 'd3m.primitives.data_transformation.load_single_graph.ExlineSingleGraphLoader',
            'source': {
                'name': 'exline',
