...
from exline.modeling.community_detection import CommunityDetection as _CommunityDetection
...
class ExlineCommunityDetectionPrimitive(PrimitiveBase[container.List, container.DataFrame, Params, Hyperparams]):
    """
    ...
    metadata = metadata_base.PrimitiveMetadata(
        {
            ...
            'python_path': 'd3m.primitives.data_transformation.community_detection.ExlineCommunityDetection',
            'source': {
                'name': 'exline',
                'contact': 'mailto:fred@qntfy.com',
                'uris': [
                    'https://github.com/uncharted-distil/distil-primitives/community_detection.py',
    ...
    def __init__(self, *,
        ...
        self._model = _CommunityDetection(target_metric=self.hyperparams['metric'])
