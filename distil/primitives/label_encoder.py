...
class SKLabelEncoder(
    ...
    def get_params(self) -> Params:
        ...
        return Params(classes_=classes, training_indices_=self._training_indices)
    ...
    def _add_target_semantic_types(
        cls, metadata: metadata_base.DataMetadata, source: typing.Any
    ) -> metadata_base.DataMetadata:
        for column_index in range(
            metadata.query((metadata_base.ALL_ELEMENTS,))["dimension"]["length"]
        ):
