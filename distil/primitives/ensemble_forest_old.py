...
class EnsembleForestOldPrimitive(PrimitiveBase[container.DataFrame, container.DataFrame, Params, Hyperparams]):
    """
    ...
    metadata = metadata_base.PrimitiveMetadata(
        {
            ...
            'source': {
                ...
                'uris': [
                    'https://github.com/uncharted-distil/distil-primitives/primitives/ensemble_forest_old.py',
