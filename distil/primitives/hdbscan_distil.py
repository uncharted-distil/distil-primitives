...
class Hdbscan(TransformerPrimitiveBase[Inputs, Outputs, Hyperparams]):
    ...
    metadata = metadata_base.PrimitiveMetadata({
        ...
        'id': "936786f8-5246-49dc-bdbd-e3595282de28",
        'version': __version__,
        'name': "hdbscan",
        ...
        'source': {
            ...
            'contact': __contact__,
            'uris': [
                'https://github.com/uncharted-distil/distil-primitives/distil/primitives/hdbscan_distil.py',
        ...
        'python_path': 'd3m.primitives.clustering.hdbscan_distil.Hdbscan',
    ...
    def __init__(self, *, hyperparams: Hyperparams, random_seed: int = 0) -> None:
        ...
        if self.hyperparams['algorithm'] == 'HDBSCAN':
            self.clf = hdbscan.HDBSCAN(min_cluster_size=self.hyperparams['min_cluster_size'],
    ...
    def produce(self, *, inputs: Inputs, timeout: float = None, iterations: int = None) -> CallResult[Outputs]:
        ...
        if self.hyperparams['required_output'] == 'feature':
            ...
            col_dict['semantic_types'] = (
            'http://schema.org/Integer', 'https://metadata.datadrivendiscovery.org/types/PredictedTarget')
